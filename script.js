document.addEventListener("DOMContentLoaded", function() {
    const phrases = [
        ...
        "El amor es rápido, pero tú más, pero tu crush es el correcaminos.",
        "Lo tuyo no es mala suerte en el amor, es castigo divino.",
        "Te quiero como amigo, pero ni eso. Mejor un bloqueito y seguimos con nuestras vidas. ¿Te suena esa frase, eh?",
        "No te voy a decir lo que pienso por si llevas rímel waterproof.",
        "Pero ¿tú te has visto? Primero arréglate esa cara de alcohólico para conquistar a alguien.",
